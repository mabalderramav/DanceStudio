...
using System.Text;
using DanceStudio.Infrastructure.Authentication.Claims;

namespace DanceStudio.Infrastructure.Authentication.TokenGenerator
{
    public class JwtTokenGenerator(IOptions<JwtSettings> jwtOptions) : IJwtTokenGenerator
    {
        ...
        public string GenerateToken(User user)
        {
            ...
            var claims = new List<Claim>
            {
                ...
                new("permissions", "studios:create"),
                new("permissions", "studios:update"),
            };
        ...
        {
            user.GetProfileTypes().ForEach(type => { claims.Add(new Claim("roles", type.Name)); });
        }
    }
}